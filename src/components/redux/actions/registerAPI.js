...
export const userRegister = createAsyncThunk(
    ...
    async (data, {rejectWithValue}) => {
        try{
            const response = await axios.post('https://cooks-corner-production.up.railway.app/v1/auth/registration', data)
...
//         try{
//             const response = await axios.post('https://cooks-corner-production.up.railway.app/v1/auth/confirmation', {token})
